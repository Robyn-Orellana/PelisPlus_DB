...
public class ClsPeliculasJDBC {
    ...
    private static final String SQL_INSERT ="insert into tb_pelis (Nombre, Año) values(?,?)";//? = parametros
    private static final String SQL_UPDATE = "update tb_pelis set Nombre=?, Año=? where Nombre=?";
    private static final String SQL_DELETE = "delete from tb_pelis where Nombre=?";
